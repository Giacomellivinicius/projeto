...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Produto p7 = new Produto(null, "Tv 56'",1200.00);
		...
		//criando clientes 
		Cliente cli1 = new Cliente(null, "Maria Silva", "webdesigner.vinicius@outlook.com", "36378912377", TipoCliente.PESSOAFISICA);
